/**
 * AI Autofill Service — calls Claude API to suggest field values
 * for a given template and partial user input.
 */
export async function getAISuggestions({ templateName, schema, partialData, context = '' }) {
  ...
  const prompt = `You are an expert document assistant for HDM Generator.
