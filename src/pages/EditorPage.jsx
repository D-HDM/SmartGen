...
export default function EditorPage() {
  ...
  // Load template from URL param or default to first
  useEffect(() => {
  ...
  // Attach template name to schema for AI context
    ...
    <div className="max-w-7xl mx-auto animate-slide-up">
      <div className="flex items-center gap-3 mb-5 no-print">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400">Fill fields · Preview · Print or Save</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-3 no-print space-y-3">
          ...
          <div className="card p-4">
            <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-2">Templates</p>
            <input
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 p-2.5 rounded-xl border text-left transition-all text-sm
                    ${template?.id === tpl.id
                      ...
                      : 'border-mist hover:border-gray-300 text-gray-700'}`}
                >
        ...
        <div className="lg:col-span-5 no-print">
          <div className="card p-5">
            <div className="flex items-center justify-between border-b border-mist pb-3 mb-4">
              ...
              <span className="text-xs bg-mist px-2.5 py-1 rounded-full text-gray-600">
                {template?.category}
              </span>
            </div>
