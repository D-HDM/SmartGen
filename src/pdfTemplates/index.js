// ============================================================
//  HDM Generator — Template Registry
//  Developer: Davix HDM
...
const pre    = v => `<div style="white-space:pre-wrap">${dash(v)}</div>`
    ...
    render: d => {
      ...
      <div style="font-family:'Times New Roman',serif;background:#fff;border:1px solid #e2e8f0;padding:1.5rem">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:.82rem;margin-bottom:1rem">
          ...
          <tfoot>
            <tr><td style="padding:.4rem;text-align:right;color:#64748b" colspan="1">Subtotal:</td><td style="padding:.4rem;text-align:right">${fmt(subtotal)}</td></tr>
